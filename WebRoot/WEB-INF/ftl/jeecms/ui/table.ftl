...
表格标签：用于显示列表数据。
	...
	width：表格的宽度。默认100%。
-->
<#macro table value listAction="v_list.do" class="pn-ltable" style="" theadClass="pn-lthead" tbodyClass="pn-ltbody" width="100%" cellspacing="0">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td align="center" class="pn-sp">
	...
	每页<input type="text" value="${value.pageSize}" maxlength="3" style="width:30px" onfocus="this.select();" onblur="refresh(this.value)" onkeypress="if(event.keyCode==13){$(this).blur();return false;}"/>条&nbsp;
